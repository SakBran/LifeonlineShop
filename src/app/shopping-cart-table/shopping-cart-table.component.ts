...
import { ShoppingCartTableDataSource, ShoppingCartTableItem } from './shopping-cart-table-datasource';
...
export class ShoppingCartTableComponent implements AfterViewInit, OnInit {
  ...
  @ViewChild(MatTable, {static: false}) table: MatTable<ShoppingCartTableItem>;
